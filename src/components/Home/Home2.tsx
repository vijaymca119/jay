          ...
          <Row>
            <Col md={8} className="home-about-description">
              ...
              <p className="home-about-body">
                ...
                <i>
                  <b className="purple">scalable web applications, microservices, and cloud-native solutions</b>, and I am also passionate about{" "}
                  <b className="purple">
            ...
            <Col md={12} className="home-about-social">
              ...
              <ul className="home-about-social-links">
                <li className="social-icons">
                  <a
                      href="https://github.com/vijaymca119" // Update with your GitHub profile
                      target="_blank"
                      rel="noreferrer"
                ...
                <li className="social-icons">
                  <a
                      href="https://x.com/vijaymca119" // Update with your Twitter profile
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
                  >
                ...
                <li className="social-icons">
                  <a
                      href="https://www.linkedin.com/in/vijay-kumar-3258b196/" // Update with your LinkedIn profile
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
                  >
                ...
                <li className="social-icons">
                  <a
                      href="https://www.instagram.com/vijay4v/" // Update with your Instagram profile
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
                  >
